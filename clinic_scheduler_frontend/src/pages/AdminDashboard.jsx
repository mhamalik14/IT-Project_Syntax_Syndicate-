          ...
          <div className="purpose-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">Total appointments this month</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold mb-2">Top Clinic</h3>
                <div className="text-2xl font-bold text-blue-600">City Clinic</div>
                <p className="text-sm text-gray-600">215 appointments</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold mb-2">Cancellation Rate</h3>
